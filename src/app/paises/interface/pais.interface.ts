...
//
//   const rESTCountrieResponse = Convert.toRESTCountrieResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface RESTCountrieResponse {
    name:           string;
...
export class Convert {
    public static toRESTCountrieResponse(json: string): RESTCountrieResponse[] {
        return cast(JSON.parse(json), a(r("RESTCountrieResponse")));
    }

    public static rESTCountrieResponseToJson(value: RESTCountrieResponse[]): string {
        return JSON.stringify(uncast(value, a(r("RESTCountrieResponse"))), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "RegionalBloc": o([
        ...
        { json: "name", js: "name", typ: "" },
        { json: "otherNames", js: "otherNames", typ: u(undefined, a("")) },
    ], false),
    "Translations": o([
        { json: "br", js: "br", typ: "" },
        { json: "pt", js: "pt", typ: "" },
